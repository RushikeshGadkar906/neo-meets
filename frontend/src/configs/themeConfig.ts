...
const themeConfig: ThemeConfig = {
  ...
  navigationSize: 135 /* Number in px(Pixels) /*! Note: This is for Vertical navigation menu only */,
  collapsedNavigationSize: 130 /* Number in px(Pixels) /*! Note: This is for Vertical navigation menu only */,
