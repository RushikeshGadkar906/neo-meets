...
const Requisition = (props: Props) => {
  ...
  return (
    <Fragment>
      <Tooltip title='Requisition'>
        <Badge
          color='error'
          badgeContent={3}
          sx={{
            '& .MuiBadge-badge': { top: 7, right: 20, zIndex: 1234 }
          }}
        >
          <Fab
            color='default'
            ...
            disableFocusRipple
          >
            <span className='icon-Requisition2' style={{ color: '#A3A3A3' }}></span>
          </Fab>
        </Badge>
      </Tooltip>
      <Menu
