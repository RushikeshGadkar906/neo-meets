    ...
    <Box
      ...
      sx={{
        ...
        ...(cardType === 'disableCard'
          ? { border: `3px solid ${theme.palette.customColors.text3}`, color: theme.palette.customColors.mainText }
          : { border: `3px solid ${theme.palette.primary.dark}`, color: theme.palette.primary.dark }),
        fontSize: '14px',
        fontWeight: 500,
        lineHeight: '15.4px'
      }}
...
export default function CustomTimelineWithStatus() {
  const theme = useTheme()
  const [screenWidth, setScreenWidth] = useState<number>(typeof window !== 'undefined' ? window.innerWidth : 0)

  const StatusObj: StatusObj = {
    1: { title: 'Approved', color: theme.palette.success.light, labelColor: theme.palette.success.main },
    2: {
      title: 'Rejected',
                  ...
                  >
                    <CardContent sx={{ padding: '16px 10px 0 10px' }}>
                        ...
                        {event.status !== null && (
                          <Chip
                            ...
                            sx={{
                              ...
                              '& .MuiChip-label': { fontSize: '12px', lineHeight: '16px', textTransform: 'capitalize' }
                            }}
                      ...
                      <Typography
                        ...
                        sx={{ mt: 2, mb: 2, lineHeight: '15.4px', marginBottom: '0.5rem' }}
                      >
                        {event.title}
                      </Typography>
                      <Typography
                      ...
                      <Typography
                        variant='body2'
                        sx={{ lineHeight: '15.4px', position: 'absolute', bottom: 15, left: 10 }}
                        color='customColors.mainText'
                        gutterBottom
                      >
                        {event.time}
