...
const DefaultPalette = (mode: Palette['mode'], skin: Skin): Palette => {
  ...
  return {
    customColors: {
      ...
      darkBg: '#282A42',
      lightBg: '#F0f2f4',
      bodyBg: mode === 'light' ? '#F0F2F4' : '#F0F2F4',
      ...
      faintPrimary: '3F41D10F',
      menuItemTextColor: '#434343',
      chipPendingContainer: '#FF950033',
      chipPendingText: '#FF9500',
      chipWarningContainer: '#E6393E33',
      extraTextColor: '#BDBDBD',
      customChipColor: '#4849DA',
      customChipBackgroundColor: '#4849DA14',
      customChipSuccessBgColor: '#82BA3D1A',
      musterdYellow: '#FFD333',
      blue400: '#5E5ED4',
      dashboardPurple: '#A74AD3',
      AccentOn2: '#5c3535',
      stepDefault: '#f5f5f7',
      musterdYellowLight: '#FFF9E5',
      musterdYellowDark: '#CCA000',
      surface1: '#F7F7FF',
      exceptionOneBackground: '#F4F1FF',
      exceptionOneText: '#7F5CFF',
      exceptionTwoBackground: '#F2F9FF',
      exceptionTwoText: '#4E9EE3',
      tableHeader: '#D6DCF3',
      ...
      darkBlue: '#26273F',
      tableHeaderText: '#4C4E64DE',
      lightestGreen: '#e6f9f0'
    },
    mode: mode,
    common: {
      black: '#000',
